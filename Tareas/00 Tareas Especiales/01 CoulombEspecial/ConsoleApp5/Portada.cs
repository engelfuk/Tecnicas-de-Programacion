...
namespace CoulombEspecial
{
    class Portada
    {
        ...
        {
            Console.WriteLine("Este programa calcula la distancia en la cual la resultante sobre la carga q2 es cero.");
            Console.WriteLine("*** Nota: La distancia es dada apartir de la carga q1. ***");
