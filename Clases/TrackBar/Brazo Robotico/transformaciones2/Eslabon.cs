...
namespace transformaciones2
{
    class Eslabon
    {
        ...
        public Eslabon(PointF pt1, PointF pt2, PictureBox picture, Graphics papel)
        {
            ...
            this.papel = papel;
            this.papel = picture.CreateGraphics();
            this.papel.TranslateTransform(picture.Width / 2, picture.Height / 2);
            pos1.Add(pt1);
            pos2.Add(pt2);
            CalculaLongitud();
            //CalculaAngulo();
        ...
        #region Publicos
        public void DibujaEslabon()
        {
            papel.DrawLine(pluma, this.pt1Inicial, this.pt2Inicial);
            
        }

        public void DibujaEslabon( Pen pluma)
        {
